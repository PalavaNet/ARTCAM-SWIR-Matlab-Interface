...
begin
  ...
  ArtCam1.CallBackPreview(Form1.Handle, BmpDraw.ScanLine[BmpDraw.Height-1], ArtCamGetSize, FALSE);
...
begin
  ...
  // Capture image
  ArtCam1.SnapShot(BmpDraw.ScanLine[BmpDraw.Height-1], ArtCamGetSize, FALSE);
...
begin
  ...
  // Capture image
  ArtCam1.Trigger(Form1.Handle, BmpDraw.ScanLine[BmpDraw.Height-1], ArtCamGetSize, FALSE);
...
begin
  ...
  case ArtCamGetBpp of
    1: begin
      ...
      pal.palVersion := $0300;
      BmpDraw.Palette := CreatePalette(PLogPalette(@pal)^);
    end;
