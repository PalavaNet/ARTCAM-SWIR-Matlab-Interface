...
type
  ...
  DeviceNameList = array[0..9, 0..255] of AnsiChar;
    ...
    CAMERAINFO = record
      ...
      dExposureExMin:   double;     // Min value of Shutter Width(Return -1 if disabled)
      dExposureExMax:   double;     // Max value of Shutter Width(Return -1 if disabled)
    end;
  ...
  AC_GetTemperatureEx		= function (hACam: HACAM; Error: LPBOOL):		double; cdecl;
  AC_SetExposureTimeEx		= function (hACam: HACAM; Value: double):		BOOL; cdecl;
  AC_GetExposureTimeEx		= function (hACam: HACAM; Error: LPBOOL):		double; cdecl;
  ...
  protected
	...
	F_GetTemperatureEx				AC_GetTemperatureEx;
	F_SetExposureTimeEx				AC_SetExposureTimeEx;
	F_GetExposureTimeEx				AC_GetExposureTimeEx;
  ...
  public
	...
	function GetTemperatureEx			(Error: LPBOOL):		double; cdecl;
	function SetExposureTimeEx			(Value: double):		BOOL;   cdecl;
	function GetExposureTimeEx			(Error: LPBOOL):		double; cdecl;
...
begin
  ...
  @F_GetTemperatureEx	:= nil;
  @F_SetExposureTimeEx	:= nil;
  @F_GetExposureTimeEx	:= nil;
...
begin
  ...
  if FDLLHandle<>0 then begin
	...
	@F_GetTemperatureEx:= 	GetProcAddress(FDLLHandle, 'ArtCam_GetTemperatureEx');
	@F_SetExposureTimeEx:= 	GetProcAddress(FDLLHandle, 'ArtCam_SetExposureTimeEx');
	@F_GetExposureTimeEx:= 	GetProcAddress(FDLLHandle, 'ArtCam_GetExposureTimeEx');
...
function TArtCam.GetTemperatureEx (Error: LPBOOL): double;
begin
	if	@F_GetTemperatureEx	<>nil then
	begin
		Result := F_GetTemperatureEx(SdkHandle, Error);
		exit;
	end;
	Result:= 0.0;
end;

function TArtCam.SetExposureTimeEx (Value: boule): BOOL;
begin
	if	@F_SetExposureTimeEx	<>nil then
	begin
		Result := F_SetExposureTimeEx(SdkHandle, Value);
		exit;
	end;
	Result:= FALSE;
end;

function TArtCam.GetExposureTimeEx (Error: LPBOOL): double;
begin
	if	@F_GetExposureTimeEx	<>nil then
	begin
		Result := F_GetExposureTimeEx(SdkHandle, Error);
		exit;
	end;
	Result:= -1.0;
end;
